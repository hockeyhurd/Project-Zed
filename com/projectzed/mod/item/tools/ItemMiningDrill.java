 ...
 * @version Mar 30, 2015
 */
public class ItemMiningDrill extends AbstractItemPowered {
	 ...
	 */
	public ItemMiningDrill(ToolMaterial mat, String name, int capacity, int chargeRate, IToolSetRegistry reg) {
