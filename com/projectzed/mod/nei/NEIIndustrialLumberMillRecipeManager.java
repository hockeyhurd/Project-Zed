 ...
 * @version Feb 5, 2015
 */
public class NEIIndustrialLumberMillRecipeManager extends NEIIndustrialFurnaceRecipeManager {

	@Override
	public String getRecipeName() {
		return "Industrial Lumber Mill";
	}
	
	@Override
	public void loadCraftingRecipes(String outputId, Object... results) {
		if (outputId.equals("smelting") && getClass() == NEIIndustrialLumberMillRecipeManager.class) {
			Map<ItemStack, ItemStack> recipes = LumberMillRecipesRegistry.getMap();
	...
	public void loadUsageRecipes(String inputId, Object... ingredients) {
		if (inputId.equals("fuel") && getClass() == NEIIndustrialLumberMillRecipeManager.class) 
	...
	public void loadUsageRecipes(ItemStack ingredient) {
		...
		ItemStack stack = LumberMillRecipesRegistry.millingList(ingredient);
