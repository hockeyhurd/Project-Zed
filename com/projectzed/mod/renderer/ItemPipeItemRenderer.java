...
/**
 * Class containing rendering code for item pipes.
 * 
 * @author hockeyhurd
 * @version Jun 4, 2015
 */
@SideOnly(Side.CLIENT)
public class ItemPipeItemRenderer extends AbstractItemRenderer implements IItemRenderer {
	 ...
	 */
	public ItemPipeItemRenderer(IIcon icon) {
		this(icon, false);
	}
	 ...
	 */
	public ItemPipeItemRenderer(IIcon icon, boolean renderInside) {
		super(icon);
