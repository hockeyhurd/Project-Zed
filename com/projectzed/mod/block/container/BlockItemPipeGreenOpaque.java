 ...
 * @version Jun 4, 2015
 */
public class BlockItemPipeGreenOpaque extends AbstractBlockItemPipe {

	/**
	 * @param material
	 */
	public BlockItemPipeGreenOpaque(Material material) {
		super(material, "itemPipeGreenOpaque", EnumColor.GREEN_OPAQUE);
	}
	...
	public AbstractTileEntityPipe getTileEntity() {
		return new TileEntityItemPipeGreenOpaque();
	}
